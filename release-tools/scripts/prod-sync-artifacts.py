        ...
        with open('manifest.yml') as manifest:
            ...
            for plugin in source.get('plugins'):
                try:
                    ...
                    print(ex)
            print("\n\n\n\n")
            odfe_es = [["x64.tar.gz","prod-backup/tarball/opendistro-elasticsearch/"],
                       ["arm64.tar.gz","prod-backup/tarball/opendistro-elasticsearch/"],
                       ["exe","prod-backup/downloads/odfe-windows/odfe-executables/"],
                       ["zip","prod-backup/downloads/odfe-windows/ode-windows-zip/"],
                       ["x64.rpm","prod-backup/downloads/rpms/opendistroforelasticsearch/"],
                       ["arm64.rpm","prod-backup/downloads/rpms/opendistroforelasticsearch/"],
                       ["x64.deb","prod-backup/downloads/debs/opendistroforelasticsearch/"],
                       ["arm64.deb","prod-backup/downloads/debs/opendistroforelasticsearch/"]]
            odfe_kb = [["x64.tar.gz","prod-backup/tarball/opendistroforelasticsearch-kibana/"],
                       ["arm64.tar.gz","prod-backup/tarball/opendistroforelasticsearch-kibana/"],
                       ["exe","prod-backup/downloads/odfe-windows/odfe-executables/"],
                       ["zip","prod-backup/downloads/odfe-windows/ode-windows-zip/"],
                       ["x64.rpm","prod-backup/downloads/rpms/opendistroforelasticsearch-kibana/"],
                       ["arm64.rpm","prod-backup/downloads/rpms/opendistroforelasticsearch-kibana/"],
                       ["x64.deb","prod-backup/downloads/rpms/opendistroforelasticsearch-kibana/"],
                       ["arm64.deb","prod-backup/downloads/rpms/opendistroforelasticsearch-kibana/"]]
